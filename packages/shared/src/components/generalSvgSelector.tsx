...
export const GeneralSvgSelector = ({ svgName, params = {width: 18, height: 18, fill: '#fafafa', stroke: '#fafafa'} }: generalSvgSelectorProps): React.JSX.Element => {
    switch (svgName) {
        case generalSvgNames.eye:
            return (
                <svg width={params.width} height={params.height} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
